    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          {/* Role Cards (Updated with Left-to-Right Accent Bars) */}
          <div className="space-y-6">
            
            {/* Card 1: Data Engineer (BLUE) */}
            <ScrollReveal delay={300}>
              <div className="group relative overflow-hidden bg-white dark:bg-slate-800/40 p-6 md:p-8 rounded-2xl border border-gray-100 dark:border-slate-700/50 shadow-sm hover:shadow-xl hover:border-blue-200 dark:hover:border-blue-500/50 hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                ...
                {/* Divider Line */}
                <div className="h-px w-full bg-gray-100 dark:bg-slate-700/50 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50 transition-colors duration-300 mb-4"></div>
            ...
            {/* Card 2: Backend Dev (EMERALD/GREEN) */}
            <ScrollReveal delay={400}>
              <div className="group relative overflow-hidden bg-white dark:bg-slate-800/40 p-6 md:p-8 rounded-2xl border border-gray-100 dark:border-slate-700/50 shadow-sm hover:shadow-xl hover:border-emerald-200 dark:hover:border-emerald-500/50 hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                ...
                <div className="flex items-center gap-4 mb-4">
                  {/* ICON BOX */}
                  <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-500/20 rounded-xl group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-white group-hover:shadow-[0_0_15px_rgba(16,185,129,0.5)] transition-all duration-300">
                    <Code2 size={24} />
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300 leading-tight">
                    Backend Dev & Microservices
                  </h3>
                </div>

                {/* Divider Line */}
                <div className="h-px w-full bg-gray-100 dark:bg-slate-700/50 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50 transition-colors duration-300 mb-4"></div>
            ...
            <ScrollReveal delay={500}>
              <div className="group relative overflow-hidden bg-white dark:bg-slate-800/40 p-6 md:p-8 rounded-2xl border border-gray-100 dark:border-slate-700/50 shadow-sm hover:shadow-xl hover:border-purple-200 dark:hover:border-purple-500/50 hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300 leading-tight">
                    AI Engineer & Agentic Systems
                  </h3>
                </div>

                {/* Divider Line */}
                <div className="h-px w-full bg-gray-100 dark:bg-slate-700/50 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/50 transition-colors duration-300 mb-4"></div>
