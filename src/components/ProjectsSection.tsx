              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
                <div className="lg:col-span-5 xl:col-span-6 flex flex-col justify-center">
                  <div className="flex flex-wrap items-center gap-3 mb-5">
                    <span className="px-2.5 py-1 bg-blue-50 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400 text-xs font-bold rounded-lg border border-blue-100 dark:border-blue-800/50">01</span>
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2 group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400 transition-colors duration-300">
                    Event-Driven Multi-Channel Notification Engine
                  </h3>
                  <p className="text-blue-600 dark:text-blue-400 text-sm font-semibold mb-5">Distributed Systems & Event-Driven Architecture</p>
          ...
          <ScrollReveal delay={300}>
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
                <div className="lg:col-span-5 xl:col-span-6 flex flex-col justify-center">
                  <div className="flex flex-wrap items-center gap-3 mb-5">
                    <span className="px-2.5 py-1 bg-purple-50 dark:bg-purple-900/40 text-purple-700 dark:text-purple-400 text-xs font-bold rounded-lg border border-purple-100 dark:border-purple-800/50">02</span>
                    <span className="flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300">
                      <Zap size={14} className="text-purple-500" /> Banking & LLM
                    </span>
                  </div>

                  <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2 group-hover:text-purple-600 group-focus:text-purple-600 dark:group-hover:text-purple-400 dark:group-focus:text-purple-400 transition-colors duration-300">
                    Real-Time Banking Risk Monitoring
                  </h3>
                  <p className="text-purple-600 dark:text-purple-400 text-sm font-semibold mb-5">High-Throughput Streaming & AI Integration</p>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6">
          ...
          <ScrollReveal delay={400}>
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
                <div className="lg:col-span-5 xl:col-span-6 flex flex-col justify-center">
                  <div className="flex flex-wrap items-center gap-3 mb-5">
                    <span className="px-2.5 py-1 bg-emerald-50 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 text-xs font-bold rounded-lg border border-emerald-100 dark:border-emerald-800/50">03</span>
                    <span className="flex items-center gap-1.5 text-xs font-bold text-slate-700 dark:text-slate-300">
                      <Activity size={14} className="text-emerald-500" /> DB Sync
                    </span>
                  </div>

                  <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2 group-hover:text-emerald-600 group-focus:text-emerald-600 dark:group-hover:text-emerald-400 dark:group-focus:text-emerald-400 transition-colors duration-300">
                    Bidirectional Database Synchronization
                  </h3>
                  <p className="text-emerald-600 dark:text-emerald-400 text-sm font-semibold mb-5">Heterogeneous Database Engineering</p>
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6">
                ...
                <>
                  <div className="hidden md:flex items-center shrink-0 -mx-0.5 lg:mx-0">
                    <div className="relative w-3 lg:w-4 xl:w-5 h-[2px] bg-slate-700 overflow-hidden rounded-full">
                      <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-r from-transparent via-blue-400 to-transparent animate-data-flow-x" style={{ animationDelay: `${gIdx * 0.25}s` }} />
                    </div>
                  ...
                  <div className="md:hidden flex flex-col items-center my-1.5 shrink-0">
                    <div className="relative h-5 w-[2px] bg-slate-700 overflow-hidden rounded-full">
                      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-blue-400 to-transparent animate-data-flow-y" style={{ animationDelay: `${gIdx * 0.25}s` }} />
                    </div>
...
function TechTag({ name, icon }: { name: string; icon?: React.ReactNode }) {
  return (
    <div className="group/tag flex items-center gap-1.5 px-2.5 py-1 bg-white dark:bg-slate-900/50 border border-gray-200 dark:border-slate-700 rounded-lg hover:border-blue-400 dark:hover:border-blue-500 transition-colors cursor-default shadow-sm hover:shadow">
      {icon && <div className="flex items-center justify-center text-gray-700 dark:text-gray-300 transition-colors">{icon}</div>}
      <span className="text-[11px] font-semibold text-gray-700 dark:text-gray-300 group-hover/tag:text-blue-600 dark:group-hover/tag:text-blue-400 transition-colors">{name}</span>
    </div>
  );
}