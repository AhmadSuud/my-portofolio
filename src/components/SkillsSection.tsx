        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <ScrollReveal delay={100}>
            <div 
              tabIndex={0}
              onTouchStart={() => {}}
              className="group relative h-full overflow-hidden bg-white dark:bg-slate-800/40 p-6 md:p-8 rounded-2xl border border-gray-100 dark:border-slate-700/50 shadow-sm hover:shadow-xl focus:shadow-xl hover:border-blue-200 focus:border-blue-200 dark:hover:border-blue-500/50 dark:focus:border-blue-500/50 hover:-translate-y-1.5 focus:-translate-y-1.5 active:scale-[0.98] transition-all duration-300 cursor-pointer outline-none"
            >
              {/* ACCENT BAR */}
              <div className="absolute top-0 left-0 h-1 w-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 origin-left transform scale-x-0 opacity-0 group-hover:scale-x-100 group-hover:opacity-100 group-focus:scale-x-100 group-focus:opacity-100 transition-all duration-500 ease-out" />
              
              <div className="flex items-center gap-2 mb-1 mt-2">
                <div className="w-2 h-2 rounded-full bg-blue-500 group-hover:scale-150 group-focus:scale-150 group-hover:shadow-[0_0_8px_rgba(59,130,246,0.8)] group-focus:shadow-[0_0_8px_rgba(59,130,246,0.8)] transition-all duration-300"></div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400 transition-colors duration-300">Data Engineering & Streaming</h3>
              </div>
              <p className="text-blue-600 dark:text-blue-400 text-sm font-medium mb-4">High-Throughput & Real-Time Data</p>
              <div className="h-px w-full bg-gray-100 dark:bg-slate-700/50 group-hover:bg-blue-100 group-focus:bg-blue-100 dark:group-hover:bg-blue-900/50 dark:group-focus:bg-blue-900/50 transition-colors duration-300 mb-5"></div>
              
              <div className="flex flex-wrap gap-2">
                <TechTag name="Apache Kafka" icon={<Confluent width={16} height={16} />} />
          ...
          {/* Card 2 - Orchestration & Automation */}
          <ScrollReveal delay={200}>
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-1 mt-2">
                <div className="w-2 h-2 rounded-full bg-blue-500 group-hover:scale-150 group-focus:scale-150 group-hover:shadow-[0_0_8px_rgba(59,130,246,0.8)] group-focus:shadow-[0_0_8px_rgba(59,130,246,0.8)] transition-all duration-300"></div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400 transition-colors duration-300">Orchestration & Automation</h3>
              </div>
          ...
          {/* Card 3 - AI, Machine Learning & Agents */}
          <ScrollReveal delay={300}>
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-1 mt-2">
                <div className="w-2 h-2 rounded-full bg-blue-500 group-hover:scale-150 group-focus:scale-150 group-hover:shadow-[0_0_8px_rgba(59,130,246,0.8)] group-focus:shadow-[0_0_8px_rgba(59,130,246,0.8)] transition-all duration-300"></div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400 transition-colors duration-300">AI, LLM & Agents</h3>
              </div>
          ...
          <ScrollReveal delay={400}>
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-1 mt-2">
                <div className="w-2 h-2 rounded-full bg-blue-500 group-hover:scale-150 group-focus:scale-150 group-hover:shadow-[0_0_8px_rgba(59,130,246,0.8)] group-focus:shadow-[0_0_8px_rgba(59,130,246,0.8)] transition-all duration-300"></div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400 transition-colors duration-300">Databases & Storage</h3>
              </div>
          ...
          <ScrollReveal delay={500}>
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-1 mt-2">
                <div className="w-2 h-2 rounded-full bg-blue-500 group-hover:scale-150 group-focus:scale-150 group-hover:shadow-[0_0_8px_rgba(59,130,246,0.8)] group-focus:shadow-[0_0_8px_rgba(59,130,246,0.8)] transition-all duration-300"></div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400 transition-colors duration-300">Dev Tools & Languages</h3>
              </div>
          ...
          {/* Card 6 - Infra, DevOps & Observability */}
          <ScrollReveal delay={600}>
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-1 mt-2">
                <div className="w-2 h-2 rounded-full bg-blue-500 group-hover:scale-150 group-focus:scale-150 group-hover:shadow-[0_0_8px_rgba(59,130,246,0.8)] group-focus:shadow-[0_0_8px_rgba(59,130,246,0.8)] transition-all duration-300"></div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-blue-600 group-focus:text-blue-600 dark:group-hover:text-blue-400 dark:group-focus:text-blue-400 transition-colors duration-300">Infra & Observability</h3>
              </div>
